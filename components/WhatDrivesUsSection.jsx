...
export default function WhatDrivesUsSection() {
  ...
  useEffect(() => {
    ...
    >{/* Enhanced background with multiple layers */}
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-8">        {/* Enhanced title with glow effects and better animation structure */}
        <div className="relative mb-16">
          {/* Background glow effect */}
          <div className="absolute -inset-x-10 -inset-y-8 bg-gradient-to-r from-blue-600/10 via-indigo-600/5 to-purple-600/10 blur-3xl rounded-full"></div>
          <div className="absolute -inset-x-20 -inset-y-10 bg-[radial-gradient(ellipse_at_center,rgba(59,130,246,0.1),transparent_70%)] animate-pulse duration-5000"></div>
          
          <h2 
            ref={titleRef} 
            className="relative text-5xl md:text-6xl lg:text-8xl font-bold text-center bg-clip-text"
          >
            <span className="absolute -inset-x-full -inset-y-1/4 bg-gradient-to-b from-blue-200/5 to-transparent blur-md"></span>
            
            <span className="relative inline-block">
              {"What Drives Us".split(" ").map((word, i) => (
                <span 
                  key={i} 
                  className="inline-block mx-1 md:mx-2 title-word"
                  style={{ 
              ...
              <span className="block h-1 w-40 bg-gradient-to-r from-blue-500 to-indigo-500 mx-auto mt-6 rounded-full"></span>
            </span>
          </h2>
        </div>
