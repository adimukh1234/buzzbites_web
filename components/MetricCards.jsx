...
export default function MetricCards() {
  ...
  useEffect(() => {
    ...
    >
      <div className="container mx-auto px-4" ref={containerRef}>        <h2 className="text-4xl md:text-6xl lg:text-7xl font-satoshi font-black text-white text-center mb-8">
